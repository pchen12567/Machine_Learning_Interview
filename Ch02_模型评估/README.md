...
- 对于两个向量A和B，其余弦相似度定义为：<br>
$$ sim(A, B) = cos(A, B) = \frac{A \cdot B}{||A||_2 ||B||_2 $$
...
> [参考](https://github.com/pchen12567/AI_For_NLP/blob/master/Week_07_MachineLearning/Assignment_07.md)
